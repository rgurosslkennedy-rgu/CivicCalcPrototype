const labels = {
    en: {
        ...
        resourcesTitle: "Matched Demographic Resources",
        income: "Current Salary",
        years: "Years of Contribution",
        microYears: "PenCom Micro Pension Tracked Years",
        run: "Run Engine",
        back: "← Back to Setup Profile"
    },
    ig: {
        title: "Injin Nchedo Ndị Oha Obodo",
        subtitle: "Ngwá ọrụ kwụụrụ onwe ya na-agbakọ ego nbelata iwu.",
        summaryTitle: "Nchịkọta Nnyocha",
        resourcesTitle: "Ihe Ndị Dị Maara Profaịlụ Gị",
        income: "Ego Ọrụ Gị Ugbu A",
        years: "Afọ Ndị I Tinyere Ego Pensen",
        microYears: "Afọ Atụmatụ na Micro Pension Plan",
        run: "Gbaa Injin Ọrụ",
        back: "← Laghachi na Nhazi"
    },
    yo: {
        title: "Ẹrọ Àbò Àwùjọ Ará Ìlú",
        subtitle: "Ohun èlò tòótọ́ tíń ṣe ìṣírò àwọn owó tí òfin gé.",
        summaryTitle: "Àkópọ̀ Ìmúpọ̀",
        resourcesTitle: "Àwọn Ohun Àlùmọ́nì Tí Ó Bá Mu",
        income: "Iye Owó Iṣẹ́ Rẹ Lọ́wọ́ lọ́wọ́",
        years: "Iye Ọdún Tí O Ti Sanwó Sínú Ètò",
        microYears: "Iye Ọdún Nínú Micro Pension Plan",
        run: "Ṣiṣẹ Ẹrọ",
        back: "← Padà Sínú Ìṣètò"
    },
    sn: {
        title: "Yunivhesari Civic Dziviriro Enjini",
        subtitle: "Chishandiso chakazvimiririra chinoverengera zvisungo zvomutemo.",
        summaryTitle: "Pfupiso Ongororo",
        resourcesTitle: "Zvakafanira Profile Zviwanikwa",
        income: "Mari Yako Yeizvozvi",
        years: "Makore Ekupinda muChirongwa",
        microYears: "Makore Anofungidzirwa muMicro Pension",
        run: "Mhanyisa Enjini",
        back: "← Dzokera Kumashure"
    }
};

const localizedStrings = {
    en: {
        node: "Analysis Context Node",
        tracked: "Tracked Asset Span",
        years: "Years",
        income: "Current Salary",
        cumulative: "Cumulative Modeled Asset Vault Inflow",
        nssa: "Aggregate NSSA Modeled Protection Value",
        ...
        unemp_zw: "Informal/Unemployed Tracking. Social support safety nets fall back onto the regional Department of Social Development networks via AMTO welfare options.",
        micro_opt: "Micro Pension Optimization Target",
        micro_proj: "Projected Savings Projection Vector",
    ...
    ig: {
        node: "Ebe Nnyocha Profaịlụ",
        tracked: "Oge Ntụle Ego Gị",
        years: "Afọ",
        income: "Ego Ọrụ Gị Ugbu A",
        cumulative: "Ngụkọta Ego Pensen Na-abata",
        nssa: "Ngụkọta Ego Nchedo NSSA Maka Gị",
        ret_ok: "Ị ruru afọ ezumike nká iwu kwadoro. E mepụtara ụzọ nkesa pensen gị.",
        ...
        unemp_ng: "Ọkwa: Enweghị ọrụ. Enweghị nsochi ego ọnwa. Ndị nwere akaụntụ mepere emepe nwere ike itinye akwụkwọ maka 25% ego mberede ma ọ bụrụ na akaụntụ ha emechiela ọnwa 4 ka ha hapụchara ọrụ.",
        ...
        micro_opt: "Ebumnuche Nkwalite Micro Pension",
        micro_proj: "Ego Atụmatụ Nchebe Onwe Gị",
    ...
    yo: {
        node: "Ojú Àwòrán Atúpale",
        tracked: "Iye Ọdún Tí A Ṣe Ìṣírò Rẹ̀",
        years: "Ọdun",
        income: "Iye Owó Iṣẹ́ Rẹ Lọ́wọ́ lọ́wọ́",
        cumulative: "Apapọ Owo Ifẹyinti Ti O Ti Kó Jọ",
        nssa: "Apapọ Iye Àbò Owo NSSA Rẹ",
        ret_ok: "O ti loju ori fun ifẹyinti gẹgẹ bi òfin. Eto sisanwo owo rẹ ti ṣii.",
        ...
        exit_zw: "A o tọju owo rẹ si NSSA titi o fi to ọjọ ori ifẹyinti. Ṣugbọn awọn ti o fẹyinti nitori aisan le gba iran lẹ lọwọ pajawiri.",
        ...
        micro_opt: "Ètò Micro Pension (MPP) Ti O Kó Jọ",
        micro_proj: "Owó Ifidámọ́rán Alágbàwí Alákọ̀ọ́bẹ̀rẹ̀",
    ...
    sn: {
        node: "Nzvimbo dzekuongorora Profile",
        tracked: "Makore Ekutarisa Midziyo",
        years: "Makore",
        income: "Mari Yako Yeizvozvi",
        cumulative: "Mari yeMudyandigere Yakachengetwa",
        nssa: "Mari yeNSSA Yakasanganiswa Dziviriro",
        ret_ok: "Zera rekurera zviri pamutemo rasvikwa. Mudyandigere wavhurwa.",
        ...
        micro_opt: "Micro Pension Inotarisirwa Target",
        micro_proj: "Mari Inofungidzirwa muMicro Pension",
